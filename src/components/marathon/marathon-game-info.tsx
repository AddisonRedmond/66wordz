...
const MarathonGameInfo: React.FC<MarathonGameInfoProps> = ({
  ...
  return (
    <div className="mx-auto flex w-fit items-center justify-center gap-x-5 rounded-lg bg-gray-100 p-4 text-lg font-semibold shadow-md">
      <div className="flex items-center justify-center gap-x-1 text-[#7233CA]">
        <span>
          <Image
            height={15}
            width={15}
      ...
      <div className="flex flex-grow items-center gap-1">
        ...
        <p className="w-10">{`${minutes}:${seconds.toString().padStart(2, "0")}`}</p>
      </div>
      <div>
