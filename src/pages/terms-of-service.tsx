const TermsOfService = () => {
  return (
    <div>
      <p>
        Terms and Conditions Last updated: February 15, 2023 Please read these
        ...
        authority. Country refers to: Tennessee, United States Company (referred
        to as either "the Company", "We", "Us" or "Our" in this Agreement)
        refers to Seibert Software Solutions, LLC, . Device means any device
        ...
        Service. Third-party Social Media Service means any services or content
        ...
        Service. Website refers to Icon Generator AI, accessible from
        icongeneratorai.com You means the individual accessing or using the
        ...
        then You may not access the Service. Your access to and use of the
        ...
        read Our Privacy Policy carefully before using Our Service. Refund
        Policy By using this site and buying credits, you agree to our refund
        policy and will not seek to ask for refunds if you are unhappy with the
        results of your AI generated icons. You understand the limitations of AI
        art. Some of these limitations include an inability to generate letters
        and characters, often misintreprts prompts, often might have deformed
        results, etc. When buying credits, you accept the risk that some AI
        generated icons may not be perfect. Links to Other Websites Our Service
        ...
        visit. Icon Generation We can use your icons to promote our service.
        This includes, but is not limited to: online ads, physical ads, social
        media posts, and anywhere inside this application. Termination We may
        ...
        You breach these Terms and Conditions. Upon termination, Your right to
        use the Service will cease immediately. Limitation of Liability Our
        service uses AI provided by OpenAI to generate icons. Please review
        ...
        contact us: By email: icongeneratorai@gmail.com
      </p>
    </div>
  );
};
